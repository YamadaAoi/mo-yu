...
| [CircleGeometryOption](./cesium.circlegeometryoption.md)                   | CircleGeometry 构造参数                                                                                                                                                                                  |
| [CirclePrimitiveOption](./cesium.circleprimitiveoption.md)                 | 圆 Primitive 构造参数 混合 Primitive 和 GroundPrimitive 和 GeometryInstance 和 CircleGeometry 的构造参数                                                                                                 |
...
| [GroundPolylineGeometryOption](./cesium.groundpolylinegeometryoption.md)   | GroundPolylineGeometry 构造参数                                                                                                                                                                          |
| [GroundPolylinePrimitiveOption](./cesium.groundpolylineprimitiveoption.md) | GroundPolylinePrimitive 通用构造参数 剔除 appearance，geometryInstances 属性                                                                                                                             |
| [GroundPrimitiveOption](./cesium.groundprimitiveoption.md)                 | GroundPrimitive 通用构造参数 剔除 appearance，geometryInstances 属性                                                                                                                                     |
| [PolygonGeometryOption](./cesium.polygongeometryoption.md)                 | PolygonGeometry 构造参数                                                                                                                                                                                 |
| [PolygonPrimitiveOption](./cesium.polygonprimitiveoption.md)               | 面 Primitive 构造参数 混合 Primitive 和 GroundPrimitive 和 GeometryInstance 和 PolylineGeometry 的构造参数                                                                                               |
| [PolylineGeometryOption](./cesium.polylinegeometryoption.md)               | PolylineGeometry 构造参数                                                                                                                                                                                |
| [PolylinePrimitiveOption](./cesium.polylineprimitiveoption.md)             | 线 Primitive 构造参数 混合 Primitive 和 GroundPolylinePrimitive 和 GeometryInstance 和 GroundPolylineGeometry 和 PolylineGeometry 的构造参数                                                             |
